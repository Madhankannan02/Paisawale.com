  ...
  return (
    <div className="bg-bg-base min-h-screen selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <main>
        ...
        {/* Transition Divider matching reference style */}
        ...
        {/* Latest Insights / Blog Style Section from Reference Bottom */}
        ...
        {/* Final CTA Banner matching reference's high-contrast bottom banner */}
